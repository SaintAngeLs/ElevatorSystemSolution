declare module 'elevator-system-class-library' {
  ...
  export class ElevatorService {
      ...
      handlePickupRequest(request: ElevatorRequest): Promise<Elevator | null>;
      handleUpdate(
          id: number,
          currentFloor: number,
          targetFloor: number,
      ...
      findNearestElevator(elevators: Elevator[], floor: number): Elevator | null;
      findLeastRecentlyAvailableElevator(elevators: Elevator[]): Elevator | null;
      processPendingRequests(): Promise<void>;
      addPickupRequestToQueue(floor: number, direction: number): Promise<void>;
      processPendingRequests(): Promise<void>;
  }
